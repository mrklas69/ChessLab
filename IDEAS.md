...
- **v2.7: Move ordering (MVV-LVA)** — Most Valuable Victim - Least Valuable Aggressor: prioritizuj captures podle "berem velkou figuru levnou". α-β cutoffs se tím dramaticky zlepší (typicky 2-5× rychlejší search se stejnou hloubkou), quiescence taky (zkrátí branching factor v capture sequences). Předpoklad pro efektivní depth 3+.
