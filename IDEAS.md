...
- **Engine sparring** — turnaj N enginů, round-robin, ELO výpočet (Bayesian / linear regression). (Areny 1v1 hotové + ChessLab Elo persistent rating per engine s K-factor adaptace; round-robin batch + Bayesian by zlepšil konvergenci.)
