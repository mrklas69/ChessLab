...
- **Engine arena** na `/arena` — dva UCI enginy (Stockfish vs. Stockfish s různými skill levely, nebo custom UCI binárka) proti sobě, batch 1-20 partií, alternace barev. Výstup: score % + performance rating diff + tabulka partií s per-game PGN download.
